function mlxshake_make_release(newVersion)
% Cut a release of MlxShake
%
% mlxshake_make_release newVersion
%
...
if ismac
  ...
  system('open "https://github.com/janklab/MlxShake/releases"')
end
