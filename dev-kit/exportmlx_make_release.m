function exportmlx_make_release(newVersion)
% Cut a release of ExportMlx
%
% exportmlx_make_release newVersion
%
...
echo("   https://github.com/janklab/ExportMlx/releases")
if ismac
  % TODO: Figure out how to do this on Windows and Linux
  system('open "https://github.com/janklab/ExportMlx/releases"')
end
